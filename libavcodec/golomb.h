...
static __inline unsigned svq3_get_ue_golomb(GetBitContext *gb)
{
    uint32_t buf;
...
#else
static __inline int get_se_golomb_long(GetBitContext *gb)
{
 ...
 */
static __inline int get_ur_golomb(GetBitContext *gb, int k, int limit,
                                int esc_len)
{
    unsigned int buf;
    int log;
 ...
 */
static __inline int get_ur_golomb_jpegls(GetBitContext *gb, int k, int limit,
                                       int esc_len)
{
    unsigned int buf;
    int log;
 ...
 */
static __inline int get_sr_golomb(GetBitContext *gb, int k, int limit,
                                int esc_len)
{
 ...
 */
static __inline int get_sr_golomb_flac(GetBitContext *gb, int k, int limit,
                                     int esc_len)
{
...
static __inline int get_ue(GetBitContext *s, const char *file, const char *func,
                         int line)
{
...
static __inline int get_se(GetBitContext *s, const char *file, const char *func,
                         int line)
{
    int show = show_bits(s, 24);
    int pos  = get_bits_count(s);
...
static __inline int get_te(GetBitContext *s, int r, char *file, const char *func,
                         int line)
{
    int show = show_bits(s, 24);
    int pos  = get_bits_count(s);
 ...
 */
static __inline void set_ur_golomb(PutBitContext *pb, int i, int k, int limit,
                                 int esc_len)
{
    int e;
 ...
 */
static __inline void set_ur_golomb_jpegls(PutBitContext *pb, int i, int k,
 ...
 */
static __inline void set_sr_golomb(PutBitContext *pb, int i, int k, int limit,
                                 int esc_len)
{
    int v;
 ...
 */
static __inline void set_sr_golomb_flac(PutBitContext *pb, int i, int k,
                                      int limit, int esc_len)
{
    int v;
