...
static __inline unsigned int get_bits_le(GetBitContext *s, int n)
{
    register int tmp;
    OPEN_READER(re, s);
    av_assert2(n>0 && n<=25);
 ...
 * Read 0-64 bits.
 */
static __inline uint64_t get_bits64(GetBitContext *s, int n)
{
    if (n <= 32) {
...
static __inline const uint8_t *align_get_bits(GetBitContext *s)
{
...
static __inline int skip_1stop_8data_bits(GetBitContext *gb)
{
...
static __inline int get_bits_trace(GetBitContext *s, int n, const char *file,
...
static __inline int get_vlc_trace(GetBitContext *s, VLC_TYPE (*table)[2],
...
static __inline int get_xbits_trace(GetBitContext *s, int n, const char *file,
                                  const char *func, int line)
{
